// from here: https://codesandbox.io/p/sandbox/wispy-https-ugmpr9?file=%2FApp.js%3A23%2C40&utm_medium=sandpack
...
class CustomLayer extends Abstract {
  ...
  static u_colorA = "#7c7c7c";
  static u_colorB = "#cbcbcb";
  static u_cloudTint = "#2d2d2d";
  static u_gain = 0.5;
